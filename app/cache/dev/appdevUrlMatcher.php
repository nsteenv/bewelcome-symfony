...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // bewelcome_rox_default_index
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?<name>[^/]+)$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'BeWelcome\\RoxBundle\\Controller\\DefaultController::indexAction',)), array('_route' => 'bewelcome_rox_default_index'));
        }

        // bewelcome_profile_default_index
        if ($pathinfo === '/bewelcome/profile/list') {
            return array (  '_controller' => 'BeWelcome\\ProfileBundle\\Controller\\DefaultController::indexAction',  '_route' => 'bewelcome_profile_default_index',);
        }

        // bewelcome_profile_default_memberdetails
        if (0 === strpos($pathinfo, '/bewelcome/profile/details') && preg_match('#^/bewelcome/profile/details/(?<id>[^/]+)$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'BeWelcome\\ProfileBundle\\Controller\\DefaultController::memberDetailsAction',)), array('_route' => 'bewelcome_profile_default_memberdetails'));
        }
